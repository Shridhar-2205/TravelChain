    ...
    componentDidMount() {
      ...
      render() {
        ...
        if (allhomes === null || loading) {
            homeItems = <h4 className="text-center">No helicopters have been added by the any of the home owners so far</h4>;
        } else {
              ...
              <div className="row">
                <div className="col-md-12">
                  <div className="row">
                    ...
                    <div className="col-8" >
                      <h2 className="display-8 text-center">Helicopters Available</h2>
                    </div>
                  ...
                  <p className="lead text-center">
                    <i>Find the best helicopters around the Country for affordable prices</i>
                  </p>
                  {homeItems}
                  <br/>
                  <br/> 
